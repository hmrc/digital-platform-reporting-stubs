...
class InternalAuthTokenInitialiserImpl @Inject() (
  ...
  private implicit lazy val scheduler: Scheduler = actorSystem.scheduler
  ...
  override val initialised: Future[Done] =
    retry(ensureAuthToken(), delay = 30.seconds, maxAttempts = 10)
      ...
      .withBody(Json.obj(
        ...
        "permissions" -> Seq(
          Json.obj(
            ...
            "resourceLocation" -> "digital-platform-reporting-stubs",
