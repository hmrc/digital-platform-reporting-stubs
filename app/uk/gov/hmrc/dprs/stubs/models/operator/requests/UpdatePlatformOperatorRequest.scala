...
import uk.gov.hmrc.dprs.stubs.models.operator.{AddressDetails, ContactDetails, Notification, TinDetails}

final case class UpdatePlatformOperatorRequest(subscriptionId: String,
                                               operatorId: String,
                                               operatorName: String,
...
object UpdatePlatformOperatorRequest {
  ...
  implicit lazy val reads: Reads[UpdatePlatformOperatorRequest] = (
    (__ \ "POManagement" \ "RequestDetails" \ "SubscriptionID").read[String] and
    (__ \ "POManagement" \ "RequestDetails" \ "POID").read[String] and
    ...
    (__ \ "POManagement" \ "RequestDetails" \ "AddressDetails").read[AddressDetails] and
    (__ \ "POManagement" \ "RequestDetails" \ "NotificationDetails").readNullable[Notification]
  )(UpdatePlatformOperatorRequest.apply _)
}
